...
insert into storage.buckets (id, name, public) values ('bank-source-files', 'bank-source-files', false)
on conflict (id) do nothing;
insert into storage.buckets (id, name, public) values ('bank-export-files', 'bank-export-files', false)
on conflict (id) do nothing;
