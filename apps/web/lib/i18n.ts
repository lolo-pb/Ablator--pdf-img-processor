...
const dictionaries = {
  en: {
    ...
    templateForm: {
      ...
      editSubtitle: "Update the template in place. Any current review batch for it will be cleared.",
      name: "Template name",
      documentType: "Document type",
      defaultName: "Document Extractor",
      defaultDocumentType: "orders",
      columns: "Columns",
      ...
      customTextPlaceholder: "Describe what text should go here",
      enumValues: "Categories",
      enumValuesPlaceholder: "Add a category",
      addValue: "Add",
      required: "Required",
      actions: "Actions",
      removeColumn: "Remove",
      ...
      typeNumber: "Number",
      typeMoney: "Money",
      typeText: "Simple text",
      typeCustom: "Custom",
      typeEnum: "Categories",
      instructions: "Instructions",
      defaultInstructions: "Infer from the document which visible data belongs in each configured column. Extract only the rows requested by this template. Use the configured columns exactly and leave missing values blank.",
      ignoreRules: "Ignore text",
      defaultIgnoreRules: "Ignore headers, footers, logos, totals, and summary sections unless they are part of a requested row.",
      submit: "Save template",
      saveNewVersion: "Save template",
    },
    templateDetail: {
  ...
  es: {
    ...
    templateForm: {
      ...
      editSubtitle: "Actualiza la plantilla en el mismo lugar. Cualquier revision en curso se va a limpiar.",
      name: "Nombre de la plantilla",
      documentType: "Tipo de documento",
      defaultName: "Extractor de documentos",
      defaultDocumentType: "ordenes",
      columns: "Columnas",
      addColumn: "Agregar columna",
      columnLabel: "Etiqueta",
      columnKey: "Clave",
      columnType: "Tipo",
      columnConfig: "Detalles",
      customText: "Texto custom",
      customTextPlaceholder: "Describe que texto deberia ir aca",
      enumValues: "Categorias",
      enumValuesPlaceholder: "Agregar categoria",
      addValue: "Agregar",
      required: "Requerida",
      actions: "Acciones",
      removeColumn: "Quitar",
      ...
      typeNumber: "Numero",
      typeMoney: "Dinero",
      typeText: "Texto simple",
      typeCustom: "Custom",
      typeEnum: "Categorias",
      instructions: "Instrucciones",
      defaultInstructions: "Infiere del documento qué datos visibles corresponden a cada columna configurada. Extrae solo las filas solicitadas por esta plantilla. Usa exactamente las columnas configuradas y deja en blanco los valores faltantes.",
      ignoreRules: "Texto para ignorar",
      defaultIgnoreRules: "Ignora encabezados, pies de pagina, logos, totales y secciones de resumen salvo que formen parte de una fila solicitada.",
      submit: "Guardar plantilla",
      saveNewVersion: "Guardar plantilla",
    },
    templateDetail: {
