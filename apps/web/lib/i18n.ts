...
const dictionaries = {
  en: {
    ...
    templateForm: {
      ...
      defaultInstructions: "Extract one row per visible record. Use the configured columns exactly and leave missing values blank.",
  ...
  es: {
    ...
    templateForm: {
      ...
      defaultInstructions: "Extrae una fila por cada registro visible. Usa exactamente las columnas configuradas y deja en blanco los valores faltantes.",
      ...
      defaultDateLabel: "Fecha",
      defaultDescriptionLabel: "Descripcion",
      defaultAmountLabel: "Monto",
